...
flowchart TB
  ...
  %% COPYRIGHT
  %% ═══════════════════════════════════════════════════════════
  COPYRIGHT["© 2026 Jinan Kordab. All rights reserved.<br>Designed & implemented by Jinan Kordab."]
  H --- COPYRIGHT
  classDef copyright fill:#ffffff,stroke:#000000,color:#000000,stroke-width:2px
